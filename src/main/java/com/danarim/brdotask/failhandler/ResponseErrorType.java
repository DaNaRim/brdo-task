...
public enum ResponseErrorType {
     ...
     * <br>
     * For example, if the user entered an invalid email address or email address is already taken,
     * use this.
     */
    FIELD_VALIDATION_ERROR("fieldValidationError"),

    /**
     * Use this when error is caused by a form but not a specific field or when the error is caused
     * by a group of fields.
     * <br>
